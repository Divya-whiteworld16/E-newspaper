...
<html lang="en">
  ...
  <!-- Popper JS -->
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.21.7/umd/popper.min.js"></script>
  ...
  <body style="background-color:cornsilk;">
    ...
    <div class="container">
     ...
     <div class="card" style="width:100%; height:350px;" >
      <img class="card-img-top" src="giphy (1).gif" alt="Card image" height="350">
...
(function() {
  ...
  window.addEventListener('load', function() {
    ...
    <footer class="blog-footer">
      <p>Made by Php Training students</p>
      <p>
